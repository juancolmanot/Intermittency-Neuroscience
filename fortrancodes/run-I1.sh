...
# module paths
    ...
    pth_mod_08='../../modulos/functions.f90'
    pth_mod_09='../../modulos/NeuronModels.f90'
    
    pth_mod=''${pth_mod_01}' '${pth_mod_08}' '${pth_mod_09}'' #'${pth_mod_05}' '${pth_mod_07}' '${pth_mod_06}''

# object code name
    ob_cod_name='Izhikevich1.o'

# fortran code name
    f90_cod_name='Izhikevich1.f90'
