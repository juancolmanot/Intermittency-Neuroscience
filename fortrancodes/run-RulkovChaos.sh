...
# module paths
    ...
    pth_mod_02='../modulos/ran2.f90'
    pth_mod_03='../modulos/rangens_mod.f90'
    #pth_mod_04='../modulos/mzran.f90'
    pth_mod_05='../modulos/mtmod.f90'
    #pth_mod_06='../modulos/miscelaneous_mod.f90'
    pth_mod_06='../modulos/miscelaneous_mod_b4.f90'

    pth_mod=''${pth_mod_01}' '${pth_mod_02}'' # '${pth_mod_03}' '${pth_mod_05}' '${pth_mod_06}'' '${pth_mod_06}''

# object code name
    ob_cod_name='RulkovChaos.o'

# fortran code name
    f90_cod_name='RulkovChaos.f90'
