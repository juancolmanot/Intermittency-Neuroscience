...
# module paths
    pth_mod_01='../../modulos/precision.f90'
    ...
    pth_mod_09='../../modulos/maps.f90'

    pth_mod=''${pth_mod_01}' '${pth_mod_05}' '${pth_mod_09}''

# object code name
    ob_cod_name='Intermittency_type_III_bifurcation_d.o'

# fortran code name
    f90_cod_name='Intermittency_type_III_bifurcation_d.f90'
